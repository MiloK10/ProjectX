<script>
    ...
    function getUser() {
        axios.get("http://localhost:8080/projectx/users/id/" + userId)
            .then( response => {
                user = response.data;
            })
    }    
...
<div class="my-2">
    ...
    <a href="#/permissions" class="btn btn-warning border-2">Go to all permissions</a>  
</div>
...
<div class="accordion" id="details">
    <div class="accordion-item">
        ...
        <div id="flush-collapseEmail" class="accordion-collapse collapse" aria-labelledby="flush-email" data-bs-parent="#details">
            <div class="accordion-body"><a href={"mailto:" + user.email}>{user.email}</a></div>
        </div>
    </div>
    <div class="accordion-item">
        <h2 class="accordion-header" id="flush-city">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseCity" aria-expanded="false" aria-controls="flush-collapseCity">
                Place of residence
            </button>
        </h2>
        <div id="flush-collapseCity" class="accordion-collapse collapse" aria-labelledby="flush-city" data-bs-parent="#details">
    ...
    <div class="accordion-item">
        ...
        <div id="flush-collapseAge" class="accordion-collapse collapse" aria-labelledby="flush-age" data-bs-parent="#details">
    ...
    <div class="accordion-item">
        ...
        <div id="flush-collapseGender" class="accordion-collapse collapse" aria-labelledby="flush-gender" data-bs-parent="#details">
            <div class="accordion-body">{user.gender}</div>
        </div>
    </div>
</div>
